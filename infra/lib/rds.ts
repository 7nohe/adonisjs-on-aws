...
export class Rds extends Construct {
  ...
  constructor(scope: Construct, id: string, props: RdsProps) {
    ...
    const { vpc, rdsSecurityGroup, privateSubnetName } = props

    // Create a secret for the RDS credentials
    const rdsCredentials = rds.Credentials.fromGeneratedSecret('AppRunnerUser', {
      secretName: 'RDSSecret',
    })

    this.databaseCluster = new rds.DatabaseCluster(scope, 'DatabaseCluster', {
